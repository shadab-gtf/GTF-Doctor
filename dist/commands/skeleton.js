...
import { findComponent, analyzeSkeletonTarget } from "../engines/skeleton/analyzer.js";
...
export async function skeletonCheckCommand(rootDir) {
...
export async function skeletonGenerateCommand(rootDir, targetName, options) {
...
function renderProgress(value, total, payload) {
...
function phase(name, files, started) {
    return {
...
function printViewport(label, layout) {
    console.log(`${label}:`);
...
function printBulkResult(generated, skipped, timeSavedMinutes) {
